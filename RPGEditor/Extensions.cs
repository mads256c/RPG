...
namespace RPGEditor
{
    //Taget fra internettet. Kraftigt ændret af mig. Den returnere ikke længere en klasse. Nu returnerer den en liste af strenge, hvor alle nedavede klassers navner ligger i.
